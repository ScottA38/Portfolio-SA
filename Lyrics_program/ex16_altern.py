"""
string interpretation into list originally from Alex (games prog)
...
#call function which returns all alphabetc characters in lowercase and save back to original variable
lyrics = lyrics.lower()

#function replaces all newline characters with spaces and assign to original variable
lyrics = lyrics.replace("\n", " ")
# print(lyrics)

#debug of output for string.ascii_lowercase
# print(string.ascii_lowercase)

#create a string variable holding all lowercase alpabet letters and a space
acceptedChars = string.ascii_lowercase + " "

print(f"String for acceptedChars is: '{acceptedChars}'")

#init empty string for lyrics
strippedLyrics = ""

#iterate through lyrics string (each char)
for char in lyrics:
    #check if char macthes within ascii_lowercase or as a space
    if char in acceptedChars:
        #add the current iterated char from lyrics to the 'strippedLyrics' string
        strippedLyrics = strippedLyrics + char
#debug
print(strippedLyrics)
